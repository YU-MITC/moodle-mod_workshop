...
// Output students' resources as ZIP file.
if ($action == 'downloadall' && has_capability('mod/workshop:viewallsubmissions', $PAGE->context, $USER)) {
    $res = $workshop->view($action);
...
if (has_capability('mod/workshop:viewallsubmissions', $PAGE->context, $USER)) {
    $url = new moodle_url('/mod/workshop/view.php', array('id'=>$id, 'action'=>'downloadall'));
